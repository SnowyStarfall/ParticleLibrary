...
namespace ParticleLibrary.Core
{
	public class GParticleSystem : IDisposable
	{
		...
		public GParticleSystem(Texture2D texture, int maxParticles, int lifespan) : this()
		{
			if (texture is null)
		...
		public GParticleSystem(GParticleSystemSettings settings) : this()
		{
		...
		public void AddParticle(Vector2 position, Vector2 velocity, GParticleSettings settings)
		{
			...
			Vector2 size = new(Texture.Width * settings.Scale.X, Texture.Height * settings.Scale.Y);
