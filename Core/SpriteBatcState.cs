...
namespace ParticleLibrary.Core
{
	...
	/// This allows them to be restored later using <see cref="Apply(SpriteBatch, in SpriteBatcState)"/>. The private field <see cref="SpriteBatch.beginCalled"/> is also publicized and is used to ensure runtime safety for <see cref="Apply(SpriteBatch, in SpriteBatcState)"/>.
	/// </summary>
	/// <param name="spriteBatch"></param>
	public readonly struct SpriteBatcState(SpriteBatch spriteBatch)
	{
		...
		/// <summary>
		/// Applies the provided <see cref="SpriteBatcState"/>'s values to the provided <see cref="SpriteBatch"/>.
		...
		/// <param name="spriteBatchState">The <see cref="SpriteBatcState"/> to reference the values of.</param>
		public static void Apply(SpriteBatch spriteBatch, in SpriteBatcState spriteBatchState)
		{
